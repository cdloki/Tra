            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-6" style="text-align: right">
                        <a class="btn btn-de-secondary" href="{{route('products.index')}}" ><i class="mdi mdi-keyboard-backspace"></i> Quay lại</a>
                        <a class="btn btn-success" href="{{route('products.edit',$dataProduct['id'])}}" ><i class="mdi mdi-square-edit-outline"></i> Cập nhật</a>
                    </div>
                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                                ...
                                                                value="{{$dataProduct["code_product"]}}" disabled
                                                                onkeyup="Product.validateCode(this)" id="code_product" >
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                                ...
                                                                value="{{$dataProduct["name_product"]}}" disabled
                                                                onkeyup="Product.changeName(this)" >
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    value="{{$dataProduct["url_product"]}}" disabled
                                                                    >
                                                                </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    value="{{$dataProduct["cost"]}}" disabled
                                                                    onkeydown="maskData(this)"  >
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    value="{{$dataProduct["price"]}}" disabled
                                                                    onkeydown="maskData(this)"  >
                                                                    <div class="input-group-text">VNĐ</div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="mb-3">
                                                                ...
                                                                <textarea class="form-control my-editor-detail"  id="note" >
                                                                    {!! $dataProduct["note"]!!}
                                                                </textarea>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12">
                                                            <div class="mb-3">
                                                                <label >Mô tả</label>
                                                                <textarea class="form-control my-editor-detail"  id="description_product" >
