            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-6" style="text-align: right">
                        ...
                        <a class="btn btn-success" onclick="Product.update()" ><i class="mdi mdi-content-save"></i> Lưu</a>
                    </div>
                </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="mb-3">
                                                                ...
                                                                <textarea class="form-control my-editor"  id="note" >
                                                                    {!! $dataProduct["note"]!!}
                                                                </textarea>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12">
                                                            <div class="mb-3">
                                                                <label >Mô tả</label>
                                                                <textarea class="form-control my-editor"  id="description_product" >
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                                ...
                                                                value="{{$dataProduct["time_warranty"]}}"
                                                                id="time_warranty"  >
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <textarea class="form-control my-editor"  id="gift" >
                                                                    {!! $dataProduct["gift"]!!}
                                                                </textarea>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <textarea class="form-control my-editor"  id="element_product" >
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <textarea class="form-control my-editor"  id="specifications" >
