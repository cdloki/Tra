            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-6" style="text-align: right">
                        <a class="btn btn-de-secondary" href="{{route('sliders.index')}}" ><i class="mdi mdi-close-circle-outline"></i> Hủy</a>
                        <a class="btn btn-success" onclick="Slider.save()" ><i class="mdi mdi-content-save"></i> Lưu</a>
                    </div>
                </div>
                                                    ...
                                                    <div class="row">
                                                        {{-- <div class="col-md-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" name="keyword_slider" class="form-control" id="keyword_slider" >
                                                            </div>
                                                        </div> --}}
                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                                <label for="tbutton_slider" >Nội dung nút</label>
                                                                <input type="text" name="tbutton_slider" class="form-control" id="tbutton_slider"  >
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                                <label for="location_slider" >Vị trí</label>
                                                                <input type="number" name="location_slider" class="form-control" id="location_slider" >
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="mb-3">
                                                                <label >Từ khóa</label>
                                                                <textarea class="form-control my-editor"  id="keyword_slider" ></textarea>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12">
                                                            <div class="mb-3">
                                                                <label >Mô tả</label>
                                                                <textarea class="form-control my-editor"  id="description_slider" ></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                            </div><!--end card-body-->
