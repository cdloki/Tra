            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-6" style="text-align: right">
                        ...
                        <a class="btn btn-success" onclick="Slider.update()" ><i class="mdi mdi-square-edit-outline"></i> Cập nhật</a>
                    </div>
                </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            {{-- <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="keyword_slider" class="form-control"
                                                        id="keyword_slider" value="{{$dataSlider['keyword_slider']}}">
                                                </div>
                                            </div> --}}
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="tbutton_slider" class="form-control"
                                                        id="tbutton_slider"  value="{{$dataSlider['tbutton_slider']}}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" name="location_slider" class="form-control"
                                                        id="location_slider" value="{{$dataSlider['location_slider']}}">
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    <label >Từ khóa</label>
                                                    <textarea class="form-control my-editor"  id="keyword_slider" >
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    <label >Mô tả</label>
                                                    <textarea class="form-control my-editor"  id="description_slider" >
