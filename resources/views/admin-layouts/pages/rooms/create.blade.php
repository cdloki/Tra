    ...
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-6">
                        <h4 class="card-title">Tạo phòng</h4>
                    </div>
                    <div class="col-6" style="text-align: right">
                        <a class="btn btn-de-secondary" href="{{route('rooms.index')}}" ><i class="mdi mdi-close-circle-outline"></i> Hủy</a>
                        <a class="btn btn-success" onclick="Room.save()" ><i class="mdi mdi-content-save"></i> Lưu</a>
                    </div>
                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" name="code_room" class="form-control" onkeyup="Room.validateCode(this)" id="username" >
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                                <label for="name_room" >Tên phòng <span class="required">(*)</span></label>
                                                                <input type="text" name="name_room" class="form-control" id="name_room" onkeyup="Room.changeName(this)" >
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <div class="input-group">
                                                                    <div class="input-group-text" id="choose_image" data-input="image_room">Chọn hình ảnh</div>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="mb-3">
                                                                <label >Mô tả</label>
                                                                <textarea class="form-control my-editor"  id="description_room" ></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                            </div><!--end card-body-->
