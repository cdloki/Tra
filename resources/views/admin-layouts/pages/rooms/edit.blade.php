            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-6" style="text-align: right">
                        ...
                        <a class="btn btn-success" onclick="Room.update()" ><i class="mdi mdi-square-edit-outline"></i> Cập nhật</a>
                    </div>
                </div>
                                                ...
                                                <input type="hidden" name="id" value="{{$dataRoom["id"]}}">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="mb-3">
                                                                <label >Mô tả</label>
                                                                <textarea class="form-control my-editor"  id="description_room" >{!! $dataRoom["description_room"]!!}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                            </div><!--end card-body-->
...
renderDataTagSEO(keyword_seo_room,"edit")
