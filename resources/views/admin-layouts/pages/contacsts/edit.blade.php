            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-6" style="text-align: right">
                        <a class="btn btn-de-secondary" href="{{route('contacsts.index')}}" ><i class="mdi mdi-keyboard-backspace"></i> Quay lại</a>
                        <a class="btn btn-success" onclick="Contacst.update()" ><i class="mdi mdi-square-edit-outline"></i> Cập nhật</a>
                    </div>
                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            value="{{$dataContacst["title_seo_post"]}}"
                                                            >
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
...
@section('scripts')
<script src="{{asset('admin/js/contacst/contacst.js')}}"></script>
<script >
