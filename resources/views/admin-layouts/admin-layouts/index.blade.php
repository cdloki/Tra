    ...
    <div class="left-sidebar">
        ...
        <div class="brand">
            <a href="{{route('index')}}" class="logo">
                ...
                <span>
                    {{-- <img src="{{asset($Setting["logo_general_website"])}}" alt="logo-large" class="logo-lg
                    logo-light"> --}}
                    {{-- <img src="{{asset($Setting["logo_general_website"])}}" alt="logo-large" class="logo-lg
                    logo-dark"> --}}
                </span>
                    ...
                    <ul class="navbar-nav tab-pane active" id="Main" role="tabpanel">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse " id="sidebarPage">
                                <ul class="nav flex-column">
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{route('infos.index')}}">Quản lý trang thông tin</a>
                                    </li>
                                    <!--end nav-item-->
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{route('contacsts.index')}}">Quản lý trang liên
                                            hệ</a>
                                    </li>
                                    <!--end nav-item-->
                                </ul>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse " id="sidebarPost">
                                <ul class="nav flex-column">
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{route('discount-posts.index')}}">Quản lý bài viết
                                        </a>
                                    </li>
                                    <!--end nav-item-->
                    ...
                    <a class="nav-link dropdown-toggle nav-user" data-bs-toggle="dropdown" href="#" role="button"
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <span
                                    class="d-none d-md-block fw-semibold font-12">{{Auth::guard('users')->user()->name_user}}<i
