            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-6" style="text-align: right">
                        <a class="btn btn-success" href="{{route('sliders.create')}}" ><i class="mdi mdi-plus-circle-outline"></i> Thêm</a>
                    </div>
                </div>
            </div><!--end card-header-->
            <div class="card-body">
                    ...
                    <table class="table" id="datatable_1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$item["location_slider"]}}</td>
                                <td><img src="{{asset($item["image_slider"])}}" alt="{{$item["image_slider"] == null ? "Không tìm thấy ảnh" : asset($item["image_slider"])}}" class="image-table rounded"></td>
                                <td class="text">{!! $item["description_slider"] !!}</td>
                                <td>{{$item["tbutton_slider"]}}</td>
                                <td><a href="{{$item["url_slider"]}}">{{$item["url_slider"]}}</a></td>
                                ...
                                <td class="text-end">
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dLabel11">
                                            <a class="dropdown-item" href="{{route('sliders.show',$item['id'])}}"><i class="mdi mdi-information"></i> Xem chi tiết</a>
                                            <a class="dropdown-item" href="{{route('sliders.edit',$item['id'])}}"><i class="mdi mdi-square-edit-outline"></i> Cập nhật</a>
