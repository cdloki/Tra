       ...
       <div class="row">
          <div class="col-xxl-8 col-lg-7">
            ...
            <div class="th-blog blog-single has-post-thumbnail">
                <div class="blog-img"><a href="{{route('discount-post.show',$item['url_post'])}}"><img src="{{asset($item["image_post"])}}" alt="Blog Image"></a></div>
                <div class="blog-content">
                   <div class="blog-meta"><a class="author" ><i class="far fa-user"></i>Admin</a> <a ><i class="far fa-calendar"></i>{{$item["created_at"]}}</a> <a href="blog-details.html"><i class="far fa-comments"></i>Comments (3)</a></div>
                   <h2 class="blog-title"><a href="{{route('discount-post.show',$item['url_post'])}}">{{$item["name_post"]}}</a></h2>
                   <p class="blog-text">
                    <div class="text">
                        <p>
                        {!! $item["content_post"] !!}
                   ...
                   <a href="{{route('discount-post.show',$item['url_post'])}}" class="th-btn btn-sm">Xem thêm<i class="fas fa-chevrons-right ms-2"></i></a>
                </div>
            </div>
            @endforeach
             ...
             <aside class="sidebar-area">
                ...
                <div class="widget widget_search">
                    <form action="{{route('discount-post')}}" method="GET" class="search-form">
                        <input placeholder="Nhập từ khóa mà bạn muốn tìm ..." type="text" name="keyword" value="{{$dataDiscount["filter"]}}"
                        autocomplete="off">
                   ...
                   <div class="recent-post-wrap">
                    ...
                    <div class="recent-post">
                        ...
                        <div class="media-body">
                           <h4 class="post-title"><a class="text-inherit" href="blog-details.html">{{$item["name_post"]}}</a></h4>
                           <div class="recent-post-meta"><a href="blog.html"><i class="far fa-calendar"></i>{{$item["created_at"]}}</a></div>
                        </div>
                     </div>
                    @endforeach
