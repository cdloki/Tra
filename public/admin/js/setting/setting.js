let Setting = {
    ...
    //         $.ajax({
    //             url: laroute.route('settings.store'),
    //             method: 'POST',
    //             data: data,
    ...
    //                     })
    //                         .then(function () {
    //                             is_quit == 0 ? window.location.href = laroute.route('settings.index') : location.reload(true);
    //                         });
    ...
    //         if (result.value) {
    //             $.ajax({
    //                 url: laroute.route('settings.change-status'),
    //                 method: 'POST',
    //                 data: {
    //                     id: id
    //                 },
    ...
    //         if (result.value) {
    //             $.ajax({
    //                 url: laroute.route('settings.remove'),
    //                 method: 'POST',
    //                 data: {
    //                     id: id
    //                 },
    ...
    update: function (is_quit = 0) {
        ...
        if (form.valid()) {
            ...
            let dataTagSeo = $('#tag_seo')[0].selectr.getValue()
            data.push({ name: "dataTagSeo", value: dataTagSeo });
            data.push({ name: "description_seo_website", value: getValueTinymce("description_seo_website") });
            $.ajax({
                url: laroute.route('settings.update'),
                method: 'POST',
                data: data,
                success: function (res) {
                    if (res.error == false) {
